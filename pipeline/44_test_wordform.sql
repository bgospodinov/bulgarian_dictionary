...
-- should be 3
INSERT INTO _res VALUES('Албион_number_of_syllables', (SELECT num_syllables FROM wordforms WHERE wordform = 'Албион'));

-- should be 3
INSERT INTO _res VALUES('Узунов_number_of_syllables', (SELECT num_syllables FROM wordforms WHERE wordform = 'Узунов'));

-- should be 0
INSERT INTO _res VALUES('number_of_wordforms_containing_latin_o', (SELECT COUNT(*) FROM wordforms WHERE wordform LIKE '%o%'));
